...
enum L {
    ...
    private static let en: [String: String] = [
        ...
        "update.upToDate.body": "Mallow {current} is the latest version.",
        "update.available.title": "Update available",
        "update.available.body": "Mallow {latest} is available — you have {current}.",
        "update.available.view": "View Release",
        "update.available.later": "Later",
        "update.failed.title": "Couldn't check for updates",
        "update.failed.body": "Please try again later, or visit the Releases page on GitHub.",
        "menu.quit": "Quit",
        "menu.undo": "Undo",
        "menu.redo": "Redo",
        "menu.cut": "Cut",
        ...
        "dialog.quit.titleOne": "You have 1 document with unsaved changes.",
        "dialog.quit.titleMany": "You have {count} documents with unsaved changes.",
        "dialog.quit.body": "If you quit now, those changes will be lost.",
        "dialog.quit.confirm": "Quit Anyway",
        // common buttons
        "common.ok": "OK",
    ...
    private static let ko: [String: String] = [
        ...
        "update.upToDate.body": "Mallow {current}이(가) 최신 버전입니다.",
        "update.available.title": "업데이트가 있습니다",
        "update.available.body": "Mallow {latest} 버전이 나왔습니다. 현재 버전은 {current}입니다.",
        "update.available.view": "릴리스 보기",
        "update.available.later": "나중에",
        "update.failed.title": "업데이트를 확인하지 못했습니다",
        "update.failed.body": "잠시 후 다시 시도하거나 GitHub 릴리스 페이지를 확인해 주세요.",
        "menu.quit": "종료",
        "menu.undo": "실행 취소",
        "menu.redo": "실행 복귀",
        "menu.cut": "오려두기",
        ...
        "dialog.quit.titleOne": "저장하지 않은 문서가 1개 있습니다.",
        "dialog.quit.titleMany": "저장하지 않은 문서가 {count}개 있습니다.",
        "dialog.quit.body": "지금 종료하면 변경 사항이 사라집니다.",
        "dialog.quit.confirm": "그래도 종료",
        "common.ok": "확인",
        "common.cancel": "취소",
    ...
    private static let ja: [String: String] = [
        ...
        "update.upToDate.title": "最新バージョンです",
        "update.upToDate.body": "Mallow {current} は最新バージョンです。",
        "update.available.title": "アップデートがあります",
        "update.available.body": "Mallow {latest} が利用可能です（現在 {current}）。",
        "update.available.view": "リリースを見る",
        "update.available.later": "後で",
        "update.failed.title": "アップデートを確認できませんでした",
        "update.failed.body": "しばらくしてから再度お試しいただくか、GitHub のリリースページをご確認ください。",
        "menu.quit": "終了",
        "menu.undo": "取り消す",
        "menu.redo": "やり直す",
        "menu.cut": "カット",
        ...
        "dialog.quit.titleOne": "保存していないドキュメントが1つあります。",
        "dialog.quit.titleMany": "保存していないドキュメントが{count}個あります。",
        "dialog.quit.body": "今終了すると、その変更は失われます。",
